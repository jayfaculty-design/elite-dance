  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn(
          "bg-accent [&>button]:bg-primary [&>button]:text-primary-foreground hover:[&>button]:bg-primary hover:[&>button]:text-primary-foreground day-range-start rounded-s-md",
        ...
        range_end: cn(
          "bg-accent [&>button]:bg-primary [&>button]:text-primary-foreground hover:[&>button]:bg-primary hover:[&>button]:text-primary-foreground day-range-end rounded-e-md",
